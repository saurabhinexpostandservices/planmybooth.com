    ...
    <div class="px-[5%] py-10 md:py-20">
        ...
        <div id="country-cards"
            ...
            @foreach ($countries as $country)
                <a href="{{ route('page.country', $country['slug']) }}" class="relative group flex items-center justify-between px-4 py-2 rounded-lg 
                    ...
                    <img src="{{ $country['featured_image'] }}" alt="{{ $country['country'] }}"
