<div
    class="bg-[#176B87]/90 min-h-[40rem] md:min-h-[45rem] mt-[-100px] flex flex-col gap-5 p-5 py-16 md:p-10 justify-center items-center font-poppins">

    <h1
        class="w-full md:w-[80%] font-[Poppins] text-center text-white text-2xl md:text-3xl lg:text-4xl tracking-wide font-bold pt-20">
        List Of Custom Exhibition Stand Contractor Companies
        <span class="text-[#64CCC5]"> Worldwide</span>
    </h1>
