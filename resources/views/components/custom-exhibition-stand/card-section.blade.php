<div>
    <div class="grid grid-cols-1 gap-10 m-5 md:m-10 lg:mx-20 font-poppins">
        ...
        @foreach ($standbuilders as $item)
            <!-- Static Card 1 -->
            <section
                class="flex flex-col md:flex-row gap-5 group bg-[#2E7A93] border border-gray-200 rounded-lg shadow ">
                <!-- Image Section -->
                ...
                <div class="p-4 w-full md:w-2/3">
                    ...
                    <div class="flex gap-5">
                        <a href="{{ route('stand-builder.show', $item['username']) }}">
                            <button
                                class="mt-4 px-2 xl:px-4 py-1 xl:py-2 duration-500 text-white text-xs xl:text-sm rounded border-2 border-white font-semibold cursor-pointer">
                                Know More
                            </button>
                        </a>
                        <a href="{{ route('stand-builder.show', $item['username']) }}">
                            <button
                                class="mt-4 px-2 xl:px-4 py-1 xl:py-2 duration-700 bg-white border-2 border-white text-[#124E65] text-xs xl:text-sm font-semibold rounded cursor-pointer">
                                Request Quotes
                            </button>
                        </a>
                    </div>
