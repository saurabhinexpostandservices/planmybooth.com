<div class="max-w-4xl mx-auto p-6 bg-white rounded shadow font-lato">
        ...
        <div>
            ...
            <div class="grid grid-cols-1 gap-4 p">
                ...
                <div class="flex flex-col mb-4">
                    ...
                    <input type="text" id="eventName" name="event_name" placeholder="Enter event name" required
                        class="p-2 border rounded" value="{{ old('event_name') }}" />
                    @error('event_name')
            ...
            <div class="mt-6">
                ...
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <!-- Stand Size -->
                    <div class="flex flex-col">
                        <label for="standSize" class="block text-gray-700 font-semibold mb-2">Stand Size <span
                                class="text-red-500 font-bold">*</span></label>
                        <div class="flex space-x-2">
                            ...
                            <select id="standUnit" name="stand_unit" class="p-2 border rounded" required>
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="flex space-x-2">
                            <input type="number" id="budget" name="budget" placeholder="Budget"
                                class="p-2 border rounded w-full" value="{{ old('budget') }}">
                            <select id="budgetCurrency" name="budget_currency" class="p-2 border rounded">
                    ...
                    <!-- File Upload -->
                    <div class="flex flex-col">
                        <label for="fileUpload" class="block text-gray-700 font-semibold mb-2">File Upload</label>
                        <input type="file" id="fileUpload" name="attachment" class="p-2 border rounded">
                        @error('attachment')
                            <p class="my-1 text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 gap-4">
                    <!-- Name -->
                    <div class="flex flex-col">
                        <label for="name" class="block text-gray-700 font-semibold mb-2">Your Name <span
                                class="text-red-500 font-bold">*</span></label>
                    ...
                    <div class="flex flex-col">
                        <label for="phone" class="block text-gray-700 font-semibold mb-2">Phone Number <span
                                class="text-red-500 font-bold">*</span></label>
                        <div class="flex">
                            <select name="countryCode" class=" p-2 border rounded ">
                            ...
                            <input type="tel" id="phone" name="phone" placeholder="Your phone number"
                                class="w-full px-4 p-2 border rounded " value="{{ old('phone') }}" required />
                        </div>
                    ...
                    <!-- Company Website -->
                    <div class="flex flex-col">
                        <label for="country" class="block text-gray-700 font-semibold mb-2">Company Website</label>
                        <input type="text" id="country" name="website" placeholder="Enter company website"
                            class="p-2 border rounded" value="{{ old('website') }}">
                        @error('website')
                            <p class="my-1 text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
