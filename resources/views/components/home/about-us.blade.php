    ...
    <div class="container mx-auto px-5 md:px-20 grid lg:grid-cols-2 gap-10 md:gap-14 items-center">
        ...
        <div class="space-y-6 ">
            ...
            <p class="text-base md:text-lg text-gray-700">
                ...
                records, positive reviews, and comprehensive service offerings to ensure a seamless exhibiting
                experience.
            </p>
            ...
            <ul class="space-y-3 text-gray-700 text-base">
                ...
                <li class="flex items-start gap-2">
                    <span class="text-[#f31054]">✔</span>
                    Interactive features like AR, LED walls, and more.
                </li>
                <li class="flex items-start gap-2">
                    <span class="text-[#f31054]">✔</span>
                    Smart space planning and timely delivery.
                </li>
                <li class="flex items-start gap-2">
                    <span class="text-[#f31054]">✔</span>
        ...
        <!-- Right Image -->
        <div class="relative left-2 top-5 md:top-10 lg:top-0 ">
            <div class="absolute -top-5 -left-5 md:-top-14 md:-left-12 w-full h-full bg-[#64CCC5] rounded-xl"></div>
            <img src="{{ asset('assets/booths/Country_pavillion.webp') }}" alt="Exhibition Booth"
                class="relative z-10 rounded-xl shadow-lg" width="600" height="500" />
        </div>
    </div>
</div>
